...
export default function AdminDashboard() {
    ...
    const kpis = [
        ...
        {
            label: 'Sessions IA',
            value: stats?.total_ai_sessions ?? 0,
            sub: `${((stats?.total_ai_tokens ?? 0) / 1000).toFixed(0)}k tokens`,
            icon: Bot,
            color: 'text-purple',
        },
        {
        ...
        <div className="space-y-8">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
                <h2 className="mb-4 font-semibold text-white">
                    Utilisateurs actifs (14 derniers jours)
                </h2>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
                {[
                    ...
                    {
                        label: 'Revenus Premium (XOF)',
                        value: (
                            stats?.premium_revenue_xof ?? 0
                        ).toLocaleString(),
                    },
                    {
                        label: 'Tokens IA totaux',
                        value:
                            ((stats?.total_ai_tokens ?? 0) / 1000).toFixed(1) +
                            'k',
                    },
                ].map((s, i) => (
                    <div
